...
| Art. 37 | Registro das operações de tratamento | 🟡 Em andamento | Registro de acessos, de operações sensíveis e da ciência destes termos; inventário de dados a cargo do Encarregado da UFCA. |
